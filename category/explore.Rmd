...
total_levels<-total_levels[!total_levels %in% c("Catenulida", ""," Catenulida", " Catenulida ")]

plots <- lapply(seq_along(total_levels), function(x) {
  
  state = resulting_ds_level[resulting_ds_level$Level == total_levels[x],]
